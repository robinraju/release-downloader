...
const thc = __importStar(__nccwpck_require__(538));
...
const download_1 = __nccwpck_require__(933);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const downloadSettings = inputHelper.getInputs();
            const res = yield (0, download_1.download)(downloadSettings);
            core.info(`Done: ${res}`);
        }
        catch (error) {
...
var hasSymbolSham = __nccwpck_require__(747);
...
var stringify = __nccwpck_require__(954);
var parse = __nccwpck_require__(912);
var formats = __nccwpck_require__(907);
...
var utils = __nccwpck_require__(360);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const qs = __nccwpck_require__(760);
const url = __nccwpck_require__(310);
