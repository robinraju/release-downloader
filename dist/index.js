...
const release_downloader_1 = __nccwpck_require__(5657);
function run() {
...
class ReleaseDownloader {
     ...
     */
    downloadReleaseAssets(dData, out) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    downloadFile(asset, outputPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.httpClient.get(asset.url, headers);
            if (response.message.statusCode === 200) {
